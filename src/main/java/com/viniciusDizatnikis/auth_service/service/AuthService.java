...
public class AuthService {
    ...
    // envia o codigo antes de criar a conta
    public String preRegister(String email) {
        if (userRepository.findByEmail(email).isPresent()) {
            throw new RuntimeException("Email já cadastrado");
        }

        // cria token temporario sem usuario ainda
        // reutiliza EmailVerificationToken mas sem FK de usuario

        // solucao mais simples: salva o email direto no token
        ...
        return "Codigo enviado para " + email;
    }
